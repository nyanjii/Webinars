...
namespace Webinars.DAL.Context
{
    public class WebinarContextInitializer: DropCreateDatabaseAlways<WebinarContext>
    {
        protected override void Seed(WebinarContext context)
        {
            ...
            Webinar w5 = new Webinar() { Name = "Вебинар 5", VideoUrl = "https://www.youtube.com/embed/bZy8Nmf6f_Q", Law = l1, LawId = l1.Id };
            ...
            Webinar w6 = new Webinar() { Name = "Вебинар 5", VideoUrl = "https://www.youtube.com/embed/bZy8Nmf6f_Q", Law = l2, LawId = l2.Id };
            Webinar w7 = new Webinar() { Name = "Вебинар 1", VideoUrl = "https://www.youtube.com/embed/Col9Av1ydS4", Law = l1, LawId = l1.Id };
            ...
            context.Webinars.Add(w6);
            context.Webinars.Add(w7);
